...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { diastolic: @reading.diastolic, name: @reading.name, systolic: @reading.systolic } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { diastolic: @reading.diastolic, name: @reading.name, systolic: @reading.systolic } }
